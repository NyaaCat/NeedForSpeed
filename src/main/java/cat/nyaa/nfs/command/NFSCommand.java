...
//                            return true;
//                        }
//                        pluginInstance.getTimerInstanceManager().unloadObjective(args[2]);
...
//                        }
//                        try {
//                            pluginInstance.getTimerInstanceManager().enableObjective(group);
...
//                            return true;
//                        }
//                        if (pluginInstance.getTimerInstanceManager().disableObjective(args[2])) {
...
//                        }
//                        if (args.length < 4) {
//                            checkAreaGroup.addCheckArea(new CheckRange(posMax.getWorld().getName(),
...
//                                if (index > checkAreaGroup.getSize() - 1)
//                                    throw new NumberFormatException();
//                                checkAreaGroup.addCheckArea(index, new CheckRange(posMax.getWorld().getName(),
//                                        new Point(posMax.getBlockX(), posMax.getBlockY(), posMax.getBlockZ()),
//                                        new Point(posMin.getBlockX(), posMin.getBlockY(), posMin.getBlockZ())));
//                                sender.sendMessage(
//                                        pluginInstance.getLanguage().checkAreaCreated.produce(
